...
with tab7:
    ...
    with col1:
        with st.form('Form1'):
            BMI=st.slider(label='BMI', min_value=0, max_value=100, key=1)
            submitted1 = st.form_submit_button('Submit 1')

    with col2:
        with st.form('Form2'):
            Glucose=st.slider(label='Glucose', min_value=0, max_value=200, key=2)
            submitted2 = st.form_submit_button('Submit 2')
    with col3:
        with st.form('Form3'):
            BloodPressure=st.slider(label='BloodPressure', min_value=0, max_value=200, key=3)
            submitted3 = st.form_submit_button('Submit 3')
    with col4:
        with st.form('Form4'):
            skinThickness=st.slider(label='SkinThickness',  min_value=0, max_value=100, key=4)
            submitted4 = st.form_submit_button('Submit 4')
    with col5:
        with st.form('for5'):
            DiabetesPedigreeFunction=st.slider(label='DiabetesPedigreeFunction', min_value=0.0, max_value=8.0, key=5)
            submitted5 = st.form_submit_button('Submit 5')
    with col6:
        with st.form('Form6'):
            Insulin=st.slider(label='Insulin', min_value=0, max_value=200, key=6)
    ...
    with col8:
        with st.form('Form8'):
            insur_cost=st.slider(label='Current monthly insurance bill', min_value=0, max_value=1500, value= 100,step=1,key=8)
            submitted8 = float(st.form_submit_button('Submit 8'))
